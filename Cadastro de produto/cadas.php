...
if ($resultado && pg_num_rows($resultado) > 0) {
    ...
    while ($row = pg_fetch_assoc($resultado)) {
        ...
        if (!empty($row['imagem'])) {
            ...
            $imgData = 'data:image/jpeg;base64,' . base64_encode(pg_unescape_bytea($row['imagem'])); // Unescape a imagem
            $imgTag = "<img src='" . $imgData . "' width='100' height='100' alt='Imagem do Produto' />";
        } else {
